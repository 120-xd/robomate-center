...
// ============================================================
//  打招呼：双手同时挥动（左手 D6，右手 D7）
//  左右手按镜像角度动作：左手 30/120，右手 150/60。
// ============================================================
void waveGesture() {
    leftHand.write(30);              // 左手抬起
    rightHand.write(150);            // 右手抬起
    delay(300);

    for (int i = 0; i < 4; i++) {    // 双手同时左右挥动 4 下
        leftHand.write((i % 2 == 0) ? 120 : 30);
        rightHand.write((i % 2 == 0) ? 60 : 150);
        delay(180);
    }

    leftHand.write(90);              // 左手归中
